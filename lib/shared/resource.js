...
Resource.prototype.addResource = function(name, path, defaults) {
   ...
   */
  if (name === undefined || /^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(name) === false) {
...
Resource.prototype.header = function(key, value) {
  ...
  return this.setOption('headers', _.deepExtend(
...
Resource.prototype.param = function(key, value) {
  ...
  return this.setOption('params', _.deepExtend(
...
Resource.prototype.query = function(key, value) {
  ...
  return this.setOption('query', _.deepExtend(
...
Resource.prototype.request = function(method, id, options, callback) {
   ...
   */
  return HTTP.call(method.toUpperCase(), this._url(id), this.getProcessedOptions(options), callback);
};


Resource.prototype.getProcessedOptions = function(options) {
  /**
   * Get options for this resource path
   */
  var _options = this.getOptions(options);

  /**
   * Process the options for functions and remove null/false values
   */
