...
Resource.prototype.request = function(method, id, options, callback) {
   ...
   */
  _options.query = self.processQuery(_options.query);
...
Resource.prototype.processQuery = function(query) {
  var queryParts = [],
  ...
  switch (Object.prototype.toString.call(query)) {
    ...
    case '[object Number]':
      /**
       * Assumes a string or number has already been encoded. (Is this a mistake?)
       */
    ...
    case '[object Boolean]':
      /**
       * @todo Decide on error for here - Boolen is invalid query String option
       */
    default:
      break;
  }
